...
class Flags
{
	...
	public static var DEFAULT_DISCORD_LOGO_KEY:String = "logo";
	public static var DEFAULT_DISCORD_CLIENT_ID:String = "1416507082772971572";
	public static var DEFAULT_DISCORD_LOGO_TEXT:String = 'FNBR: V $VERSION';
	...
	public static var DEFAULT_DIFFICULTY:String = "hard";
